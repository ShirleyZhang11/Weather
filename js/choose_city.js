...
Vcity.CitySelector.prototype = {
    ...
    createHotCity:function(){
        ...
        document.getElementById("addselectCity").appendChild(this.rootDiv);
        /* IE6 */
        this.changeIframe();
